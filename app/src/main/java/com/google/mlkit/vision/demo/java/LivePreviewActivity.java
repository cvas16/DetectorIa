...
public final class LivePreviewActivity extends AppCompatActivity
  ...
  private static final String SECURITY_MODE = "Security Surveillance Mode";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    settingsButton.setOnClickListener(
        v -> {
          if (SECURITY_MODE.equals(selectedModel)) {
    ...
    try {
      switch (model) {
        ...
        case SECURITY_MODE:
          ...
          LocalModel securityModel =
              new LocalModel.Builder()
                  .setAssetFilePath("custom_models/object_labeler.tflite")
                  .build();
          CustomObjectDetectorOptions securityOptions =
              PreferenceUtils.getCustomObjectDetectorOptionsForLivePreview(this, securityModel);
          String prohibitedStr = getSharedPreferences("security_prefs", MODE_PRIVATE)
              .getString("prohibited_objects", "Knife,Weapon");
          List<String> prohibitedList = java.util.Arrays.asList(prohibitedStr.split(","));
          cameraSource.setMachineLearningFrameProcessor(
              new ObjectDetectorProcessor(this, securityOptions, prohibitedList));
          break;
        default:
  ...
  private void showSecurityConfigDialog() {
    android.widget.EditText editText = new android.widget.EditText(this);
    String currentProhibited = getSharedPreferences("security_prefs", MODE_PRIVATE)
        .getString("prohibited_objects", "Knife,Weapon");
    editText.setText(currentProhibited);
    editText.setHint("Ej: Knife, Bottle, Chair");
