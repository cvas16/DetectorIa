...
public class ObjectDetectorProcessor extends VisionProcessorBase<List<DetectedObject>> {
  ...
  public ObjectDetectorProcessor(Context context, ObjectDetectorOptionsBase options) {
    this(context, options, new java.util.ArrayList<>());
  }

  public ObjectDetectorProcessor(Context context, ObjectDetectorOptionsBase options, java.util.List<String> prohibitedLabels) {
    super(context);
  ...
  protected void onSuccess(
    ...
    for (DetectedObject object : results) {
      graphicOverlay.add(new ObjectGraphic(graphicOverlay, object, prohibitedLabels));
    }
  }
