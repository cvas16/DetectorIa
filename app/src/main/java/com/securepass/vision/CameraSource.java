...
public class CameraSource {
  ...
  /** Libera los recursos de la cámara y del detector subyacente. */
  public void release() {
  ...
  /**
   * Abre la cámara y comienza a enviar fotogramas de vista previa al detector.
   * Los fotogramas no se muestran en pantalla.
   *
   * @throws IOException si no se pudo inicializar la textura o pantalla de vista previa.
   */
  ...
  /**
   * Abre la cámara y comienza a enviar fotogramas de vista previa al detector utilizando un SurfaceHolder.
   *
   * @param surfaceHolder el contenedor de la superficie para mostrar la vista previa.
   * @throws IOException si no se pudo usar el surface holder proporcionado.
   */
  @RequiresPermission(Manifest.permission.CAMERA)
  ...
  /**
   * Cierra la cámara y deja de enviar fotogramas al detector.
   */
  ...
  /** Cambia la orientación de la cámara (frontal/trasera). */
  ...
  /** Retorna el tamaño de vista previa actualmente en uso. */
  ...
  /**
   * Selecciona el par de tamaños de vista previa y fotografía más adecuado.
   */
  ...
  /**
   * Calcula la rotación correcta para el ID de cámara dado y aplica los parámetros.
   */
  ...
  /**
   * Limpia la GraphicOverlay y permite limpiezas adicionales en clases derivadas.
   */
