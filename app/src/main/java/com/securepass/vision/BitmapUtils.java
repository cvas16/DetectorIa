...
public class BitmapUtils {
  ...
  /**
   * Convierte YUV_420_888 a un búfer de bytes NV21.
   *
   * <p>El formato NV21 consiste en un único arreglo de bytes que contiene los valores Y, U y V.
   */
  @RequiresApi(VERSION_CODES.KITKAT)
  ...
  /** Verifica si los búferes de los planos UV de una imagen YUV_420_888 están en formato NV21. */
  @RequiresApi(VERSION_CODES.KITKAT)
  ...
  /**
   * Desempaqueta un plano de imagen en un arreglo de bytes.
   */
